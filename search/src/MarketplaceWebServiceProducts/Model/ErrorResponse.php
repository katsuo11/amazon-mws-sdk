...
/**
 * MarketplaceWebServiceProducts_Model_ErrorResponse
 * 
 * Properties:
 * <ul>
 * 
 ...
 * </ul>
 */ 
class MarketplaceWebServiceProducts_Model_ErrorResponse extends MarketplaceWebServiceProducts_Model
{

    /**
     * Construct new MarketplaceWebServiceProducts_Model_ErrorResponse
     * 
    ...
    {
        $this->_fields = array (
        'Error' => array('FieldValue' => array(), 'FieldType' => array('MarketplaceWebServiceProducts_Model_Error')),
    ...
    /**
     * Construct MarketplaceWebServiceProducts_Model_ErrorResponse from XML string
     * 
     * @param string $xml XML string to construct from
     * @return MarketplaceWebServiceProducts_Model_ErrorResponse 
     */
    public static function fromXML($xml)
    {
        ...
        if ($response->length == 1) {
            return new MarketplaceWebServiceProducts_Model_ErrorResponse(($response->item(0))); 
        } else {
            throw new Exception ("Unable to construct MarketplaceWebServiceProducts_Model_ErrorResponse from provided XML. 
     ...
     * @return MarketplaceWebServiceProducts_Model_ErrorResponse  instance
     */
    ...
    {
        $xml = "";
        $xml .= "<ErrorResponse xmlns=\"http://mws.amazonservices.com/schema/Products/2011-10-01\">";
